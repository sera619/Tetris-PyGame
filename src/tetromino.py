...
class Block(pg.sprite.Sprite):
    def __init__(self, tetromino, pos):
        ...
        #pg.draw.rect(self.image, 'blue', (1, 1, TILE_SIZE - 2, TILE_SIZE - 2), border_radius=6)
        self.image = tetromino.sprite
    ...
    def update(self):
        if self.tetromino.tetris.app.paused:
            return
        self.is_alive()
        self.set_rect_pos()
...
class Tetromino:
    def __init__(self, tetris, current=True):
        ...
        #self.shape = "I"
        #self.sprite = random.choice(tetris.app.sprites)
        self.sprite = tetris.app.sprites[TETROS_COLOR[self.shape]]
    ...
    def is_collide(self, block_posistions):
        return any(map(Block.is_collide, self.blocks, block_posistions))
    ...
    def update(self):
        ...
        # pg.time.wait(ANIM_TIME_INTERVAL)
